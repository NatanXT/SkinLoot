          ...
          <form className="perfil-form" onSubmit={onChangePassword}>
            <div className="field">
              ...
              <input
                ...
                onChange={(e) =>
                  setPwd((v) => ({ ...v, currentPassword: e.target.value }))
                }
              />
            </div>
            <div className="field">
              ...
              <input
                ...
                onChange={(e) =>
                  setPwd((v) => ({ ...v, newPassword: e.target.value }))
                }
              />
            </div>
            <div className="field">
              ...
              <input
                ...
                value={pwd.confirm}
                onChange={(e) =>
                  setPwd((v) => ({ ...v, confirm: e.target.value }))
                }
              />
            </div>
            <button className="btn btn--primary" disabled={pwdSaving}>
