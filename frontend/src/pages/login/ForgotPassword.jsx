  ...
  return (
    <div className="auth-root">
      <div className="auth-card">
        ...
        <p className="auth-subtitle">Informe seu e-mail para receber o link de redefinição.</p>
        ...
        <p className="switch">Lembrou? <Link className="link" to="/login">Voltar ao login</Link></p>
      </div>
    </div>
  );
}
