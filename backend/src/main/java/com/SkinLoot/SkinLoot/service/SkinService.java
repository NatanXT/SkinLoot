...
public class SkinService {
    ...
    // Em SkinService.java (se você tiver um)
    public Page<SkinResponse> buscarSkins(String termo, Pageable pageable) {
        return skinRepository.buscarPorNome(termo, pageable).map(SkinResponse::new);
    }
}
